...
uint32_t sdmasync_ccb_paddr_get() {
...
sdma_bd_t * sdmasync_cmdbd_ptr_get() {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/dma/sdma/sync.c $ $Rev: 816922 $")
#endif
