...
int sdmascript_lookup( sdma_scriptinfo_t * scriptinfo ) {
	...
	scriptinfo->script_addr_arr[SDMA_CHTYPE_MCU_2_SSISH]  = MCU_2_SSISH_ADDR;
	scriptinfo->script_addr_arr[SDMA_CHTYPE_SSISH_2_MCU]  = SSISH_2_MCU_ADDR;
	scriptinfo->script_addr_arr[SDMA_CHTYPE_MCU_2_SSIAPP]  = MCU_2_SSIAPP_ADDR;
	scriptinfo->script_addr_arr[SDMA_CHTYPE_SSIAPP_2_MCU]  = SSIAPP_2_MCU_ADDR;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/dma/sdma/imx6x/script.c $ $Rev: 796343 $")
#endif
