...
/* weilun@adv - dms-ba16 begin */
#if defined(CONFIG_MACH_MX6Q_DMS_BA16)
#define DEFAULT_SSI         1
#else
#define DEFAULT_SSI         2
#endif
/* weilun@adv - dms-ba16 end */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/deva/ctrl/mx/nto/arm/dll.le.v7.mx6q-sabrelite/variant.h $ $Rev: 746215 $")
#endif
