...
mx6q_update_stats (mx6q_dev_t *mx6q)
{
	...
	/* Rx RMON stats are before MAC filter, can only use the errors */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devnp/mx6x/stats.c $ $Rev: 805227 $")
#endif
