...
enum mx6_chip_rev_list {
	...
	MX6_CHIP_REV_1_3		= 0x3,
	MX6_CHIP_REV_1_4		= 0x4,
	MX6_CHIP_REV_1_5		= 0x5,
	
	/* 
	   For rev >= 2.0, chip rev enum is encoded so that major field is in upper nibble
	   and minor is in lower nibble e.g. for 2.0, major=2, minor=0.
	*/
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx6x/mx6x_startup.h $ $Rev: 783761 $")
#endif
