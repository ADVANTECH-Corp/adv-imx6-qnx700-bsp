...
extern uint32_t mx6x_get_usdhc2_clk();
extern uint32_t mx6x_get_usdhc3_clk();
extern uint32_t mx6x_get_usdhc4_clk();
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx6x/smart-device/hwi_imx6q_ddr3.c $ $Rev: 760387 $")
#endif
