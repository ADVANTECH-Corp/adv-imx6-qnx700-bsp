...
/* Variants should enable this via a startup parameter */
int enable_sdma_copy = FALSE;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx6x/load_ifs.c $ $Rev: 781278 $")
#endif
