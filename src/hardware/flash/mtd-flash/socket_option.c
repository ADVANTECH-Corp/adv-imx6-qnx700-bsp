...
**
** Ident: $Id: socket_option.c 810607 2016-08-17 14:22:29Z mdaniels@qnx.com $
*/
...
f3s_socket_option(f3s_socket_t * socket)
{
	...
	for (i = 0; i < socket->ncont_window_num; i++) {
		...
		if (verbose > 2)
			printf("(devf %s:%d) Non-contiguous window address 0x%"PRIx64" \n", 
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/flash/mtd-flash/socket_option.c $ $Rev: 810607 $")
#endif
