...
int f3s_s29glxxxs_v2islock(f3s_dbase_t *dbase,
                      f3s_access_t *access,
                      uint32_t flags,
                      uint32_t offset)
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/flash/mtd-flash/spansion/s29glxxxs_v2islock.c $ $Rev: 816666 $")
#endif
