...
#else
#error "We no longer support the old flash file system"
#endif
...
int f3s_s29glxxxs_v2islock(f3s_dbase_t * dbase, f3s_access_t * access,
			_uint32 flags, _uint32 offset);

int f3s_s29glxxxs_v2lock(f3s_dbase_t *dbase, f3s_access_t *access,
			_uint32 flags, _uint32 offset);

int f3s_s29glxxxs_v2dlock(f3s_dbase_t *dbase, f3s_access_t *access,
			_uint32 flags, _uint32 offset);

int f3s_s29glxxxs_v2plock(f3s_dbase_t *dbase, f3s_access_t *access,
			_uint32 flags, _uint32 offset);

int f3s_s29glxxxs_v2unlock(f3s_dbase_t *dbase, f3s_access_t *access,
			_uint32 flags, _uint32 offset);

int f3s_s29glxxxs_v2unlockall(f3s_dbase_t *dbase, f3s_access_t *access,
			_uint32 flags, _uint32 offset);

int f3s_s29glxxxs_flush(f3s_access_t *access);

int f3s_s29glxxxs_v2ssrop(f3s_dbase_t * dbase, f3s_access_t * access,
			_uint32 op, _uint32 offset, _int32 size,
			_uint8 * buffer);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/flash/mtd-flash/public/sys/f3s_mtd.h $ $Rev: 816666 $")
#endif
