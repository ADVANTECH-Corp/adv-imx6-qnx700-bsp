...
int32_t f3s_hyCFI_ident(f3s_dbase_t *dbase,
                        ...
                        uint32_t offset)
{
	int32_t			unit_size, geo_index, geo_pos, size;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/flash/mtd-flash/hynix/hyCFI_ident.c $ $Rev: 680332 $")
#endif
