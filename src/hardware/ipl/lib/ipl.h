...
extern unsigned long image_scan_secure (unsigned long start, unsigned long end);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/ipl/lib/ipl.h $ $Rev: 814032 $")
#endif
