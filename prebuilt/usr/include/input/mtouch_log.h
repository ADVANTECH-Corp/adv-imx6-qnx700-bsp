...
*   is sent as a message to the system logger (@c slogger2). Otherwise, the log
...
*   system logger (@c slogger2). Otherwise, the log is simply directed to
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/inputevents/public/input/mtouch_log.h $ $Rev: 815947 $")
#endif
